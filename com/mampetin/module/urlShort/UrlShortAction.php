...
require_once(BASE_ROOT.'com/mampetin/module/urlShort/UrlShortDAO.php');
class UrlShortAction
{
    private $dao;
    public function UrlShortAction()
    {
        $this->dao=new UrlShortDAO();
    }
    ...
    public function BL_listByUrl($url)
    {
        $sql = "SHORT_URL='".$url."'";
